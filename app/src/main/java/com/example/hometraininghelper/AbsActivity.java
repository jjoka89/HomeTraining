...
public class AbsActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Toolbar toolbar;
    Button btn_abs_easy_body;
    Button btn_abs_nor_body;
    Button btn_abs_hard_body;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_abs_easy_body = findViewById(R.id.btn_abs_easy_body); // 복근 초급 맨몸

        btn_abs_easy_body.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_abs_nor_body = findViewById(R.id.btn_abs_nor_body); // 복근 중급 맨몸

        btn_abs_nor_body.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_abs_hard_body = findViewById(R.id.btn_abs_hard_body); // 복근 고급 맨몸

        btn_abs_hard_body.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
