...
public class LegActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    Toolbar toolbar;
    Button btn_leg_easy_body;
    Button btn_leg_easy_home;
    Button btn_leg_nor_body;
    Button btn_leg_nor_home;
    Button btn_leg_hard_body;
    Button btn_leg_hard_home;
    @Override
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_leg_easy_body = findViewById(R.id.btn_leg_easy_body); // 다리 초급 맨몸

        btn_leg_easy_body.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_leg_easy_home = findViewById(R.id.btn_leg_easy_home); // 다리 초급 기구

        btn_leg_easy_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegEasyActivityHome.class);
                startActivity(intent);
            }
        });

        btn_leg_nor_body = findViewById(R.id.btn_leg_nor_body); // 다리 중급 맨몸

        btn_leg_nor_body.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_leg_nor_home = findViewById(R.id.btn_leg_nor_home); // 다리 중급 기구

        btn_leg_nor_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegNorActivityHome.class);
                startActivity(intent);
            }
        });

        btn_leg_hard_body = findViewById(R.id.btn_leg_hard_body); // 다리 고급 맨몸

        btn_leg_hard_body.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_leg_hard_home = findViewById(R.id.btn_leg_hard_home); // 다리 고급 기구

        btn_leg_hard_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegHardActivityHome.class);
                startActivity(intent);
            }
        });
    }
