...
public class ChestActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Toolbar toolbar;
    Button btn_chest_easy_body;
    Button btn_chest_easy_home;
    Button btn_chest_nor_body;
    Button btn_chest_nor_home;
    Button btn_chest_hard_body;
    Button btn_chest_hard_home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_chest_easy_body = findViewById(R.id.btn_chest_easy_body); // 가슴 초급 맨몸

        btn_chest_easy_body.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_chest_easy_home = findViewById(R.id.btn_chest_easy_home); // 가슴 초급 기구

        btn_chest_easy_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ChestEasyActivityHome.class);
                startActivity(intent);
            }
        });

        btn_chest_nor_body = findViewById(R.id.btn_chest_nor_body); // 가슴 중급 맨몸

        btn_chest_nor_body.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_chest_nor_home = findViewById(R.id.btn_chest_nor_home); // 가슴 중급 기구

        btn_chest_nor_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ChestNorActivityHome.class);
                startActivity(intent);
            }
        });

        btn_chest_hard_body = findViewById(R.id.btn_chest_hard_body); // 가슴 고급 맨몸

        btn_chest_hard_body.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_chest_hard_home = findViewById(R.id.btn_chest_hard_home); // 가슴 고급 기구

        btn_chest_hard_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ChestHardActivityHome.class);
                startActivity(intent);
            }
        });
    }
